...
| C++23 module,上游自带 | [`khronos.vulkan-hpp`](pkgs/k/khronos.vulkan-hpp.lua) | Khronos 自己发 `vulkan.cppm`,描述符点名即可 —— `import vulkan;`,本仓不写一行包装体 |
...
- [openkal 兼容性](docs/zh/openkal-compat.md):站点上 `openkal` 标签的含义、测量方式,以及包如何适配 openkal 依赖图。
