...
class TestLlamacppSnapshotMutations(unittest.TestCase):
    ...
    def test_rejects_legacy_descriptor_name_for_new_package(self):
        self.descriptors["ggml-org.llamacpp"]["name"] = "ggml-org.llamacpp"
        self.assert_rejected(checker.check_cohort, "descriptor name drift")
...
'''
        ...
        self.assertIn("--check-exports tools/llamacpp/module/gen_exports", result.stdout)
        self.assertIn("--tag b10069", result.stdout)
        self.assertIn("--commit 178a6c44937154dc4c4eff0d166f4a044c4fceba", result.stdout)
