...
#define FFMPEG_VERSION "8.1.2"
        ...
        macosx = {
            ...
            sources = {
                "*/src/libavcodec/{012v,4xm,8bps,8svx,a64multienc,aac_ac3_parser,aac_parser,aaccoder,aacenc,aacenc_is,aacenc_tns,aacenctab,aacps_common,aacps_fixed,aacps_float,aacpsdsp_fixed,aacpsdsp_float,aacpsy,aacsbr,aacsbr_fixed,aactab,aandcttab,aasc,ac3,ac3_channel_layout_tab,ac3_parser,ac3dec_data,ac3dec_fixed,ac3dec_float,ac3dsp,ac3enc,ac3enc_fixed,ac3enc_float,ac3tab,acelp_filters,acelp_pitch_delay,acelp_vectors,adpcm,adpcm_data,adpcmenc,adts_header,adts_parser,adx,adx_parser,adxdec,adxenc,agm,aic,alac,alac_data,alacdsp,alacenc,aliaspixdec,aliaspixenc,allcodecs,alsdec,amr_parser,amrnbdec,amrwbdec,anm,ansi,aom_film_grain,apac,apedec,aptx,aptxdec,aptxenc,apv_decode,apv_dsp,apv_entropy,apv_parser,arbc,argo,ass,ass_split,assdec,assenc,asv,asvdec,asvenc,atrac,atrac1,atrac3,atrac3plus,atrac3plusdec,atrac3plusdsp,atrac9dec,atsc_a53,audio_frame_queue,audiodsp,aura,av1_parse,av1_parser,av1dec,avcodec,avdct,avrndec,avs,avs2,avs2_parser,avs3_parser,avuidec,avuienc,bethsoftvideo,bfi,bgmc,bink,binkaudio,binkdsp,bintext,bitpacked_dec,bitpacked_enc,bitstream,bitstream_filters,blockdsp,bmp,bmp_parser,bmpenc,bmvaudio,bmvvideo,bonk,brenderpix,bsf,bswapdsp,c93,cabac,canopus,cavs,cavs_parser,cavsdata,cavsdec,cavsdsp,cbrt_data,cbrt_data_fixed,cbrt_tablegen_common,cbs,cbs_apv,cbs_av1,cbs_bsf,cbs_h264,cbs_h2645,cbs_h265,cbs_h266,cbs_lcevc,cbs_mpeg2,cbs_sei,cbs_vp8,cbs_vp9,ccaption_dec,cdgraphics,cdtoons,cdxl,celp_filters,celp_math,cfhd,cfhddata,cfhddsp,cfhdenc,cfhdencdsp,cga_data,cinepak,cinepakenc,clearvideo,cljrdec,cljrenc,cllc,cngdec,cngenc,codec_desc,codec_par,cook,cook_parser,cpia,cri,cri_parser,cscd,cyuv,d3d11va,dca,dca_core,dca_exss,dca_lbr,dca_parser,dca_sample_rate_tab,dca_xll,dcaadpcm,dcadata,dcadct,dcadec,dcadsp,dcaenc,dcahuff,dct32_fixed,dct32_float,dds,decode,dfa,dfpwmdec,dfpwmenc,dirac,dirac_arith,dirac_dwt,dirac_parser,dirac_vlc,diracdec,diracdsp,diractab,dnxhd_parser,dnxhddata,dnxhddec,dnxhdenc,dnxuc_parser,dolby_e,dolby_e_parse,dolby_e_parser,dovi_rpu,dovi_rpudec,dovi_rpuenc,dpcm,dpx,dpx_parser,dpxenc,dsd,dsddec,dsicinaudio,dsicinvideo,dss_sp,dstdec,dv,dv_profile,dvaudio_parser,dvaudiodec,dvbsub_parser,dvbsubdec,dvbsubenc,dvd_nav_parser,dvdata,dvdec,dvdsub,dvdsub_parser,dvdsubdec,dvdsubenc,dvenc,dxtory,dxv,dxvenc,dynamic_hdr_vivid,eac3_data,eac3enc,eacmv,eaidct,eamad,eatgq,eatgv,eatqi,elbg,encode,error_resilience,escape124,escape130,evc_parse,evc_parser,evc_ps,evrcdec,executor,exif,faandct,faanidct,fastaudio,faxcompr,fdctdsp,ffv1,ffv1_parse,ffv1_parser,ffv1dec,ffv1enc,ffwavesynth,fic,fits,fitsdec,fitsenc,flac,flac_parser,flacdata,flacdec,flacdsp,flacenc,flacencdsp,flicvideo,flvdec,flvenc,fmtconvert,fmvc,frame_thread_encoder,fraps,frwu,ftr,ftr_parser,g722,g722dec,g722dsp,g722enc,g723_1,g723_1_parser,g723_1dec,g723_1enc,g726,g728dec,g729_parser,g729dec,g729postfilter,gdv,gemdec,get_buffer,gif,gif_parser,gifdec,golomb,gsm_parser,gsmdec,gsmdec_data,h261,h261_parser,h261data,h261dec,h261enc,h263,h263_parser,h263data,h263dec,h263dsp,h2645_parse,h2645_sei,h2645_vui,h2645data,h264_cabac,h264_cavlc,h264_direct,h264_levels,h264_loopfilter,h264_mb,h264_parse,h264_parser,h264_picture,h264_ps,h264_refs,h264_sei,h264_slice,h264chroma,h264data,h264dec,h264dsp,h264idct,h264pred,h264qpel,h265_profile_level,h274,hap,hapdec,hashtable,hcadec,hcom,hdr_parser,hdrdec,hdrenc,hnm4video,hpeldsp,hq_common,hq_hqa,hq_hqadsp,hqx,hqxdsp,htmlsubtitles,huffman,huffyuv,huffyuvdec,huffyuvdsp,huffyuvenc,huffyuvencdsp,idcinvideo,idctdsp,iff,ilbcdec,imc,imgconvert,imm4,imm5,imx,indeo2,indeo3,indeo4,indeo5,intelh263dec,interplayacm,interplayvideo,intrax8,intrax8dsp,ipu_parser,ituh263dec,ituh263enc,ivi,ivi_dsp,j2kenc,jacosubdec,jfdctfst,jfdctint,jni,jpeg2000,jpeg2000_parser,jpeg2000dec,jpeg2000dsp,jpeg2000dwt,jpeg2000htdec,jpegls,jpeglsdec,jpeglsenc,jpegquanttables,jpegtables,jpegxl_parse,jpegxl_parser,jpegxs_parser,jrevdct,jvdec,kbdwin,kgv1dec,kmvc,lagarith,lagarithrac,latm_parser,lcevc_parser,lcevctab,lcldec,leaddec,ljpegenc,loco,lossless_audiodsp,lossless_videodsp,lossless_videoencdsp,lpc,lsp,lzf,lzw,lzwenc,m101,mace,magicyuv,magicyuvenc,mathtables,mdec,me_cmp,mediacodec,metasound,microdvddec,midivid,mimic,misc4,misc4_parser,mjpeg_parser,mjpegbdec,mjpegdec,mjpegdec_common,mjpegenc,mjpegenc_common,mjpegenc_huffman,mlp,mlp_parse,mlp_parser,mlpdec,mlpdsp,mlpenc,mlz,mmvideo,mobiclip,motion_est,motionpixels,movtextdec,movtextenc,mpc,mpc7,mpc8,mpeg12,mpeg12data,mpeg12dec,mpeg12enc,mpeg12framerate,mpeg4audio,mpeg4audio_sample_rates,mpeg4video,mpeg4video_parser,mpeg4videodec,mpeg4videodsp,mpeg4videoenc,mpeg_er,mpegaudio,mpegaudio_parser,mpegaudiodata,mpegaudiodec_common,mpegaudiodec_fixed,mpegaudiodec_float,mpegaudiodecheader,mpegaudiodsp,mpegaudiodsp_data,mpegaudiodsp_fixed,mpegaudiodsp_float,mpegaudioenc,mpegaudiotabs,mpegpicture,mpegutils,mpegvideo,mpegvideo_dec,mpegvideo_enc,mpegvideo_motion,mpegvideo_parser,mpegvideo_unquantize,mpegvideodata,mpegvideoencdsp,mpl2dec,mqc,mqcdec,mqcenc,msgsmdec,msmpeg4,msmpeg4_vc1_data,msmpeg4data,msmpeg4dec,msmpeg4enc,msp2dec,msrle,msrledec,msrleenc,mss1,mss12,mss2,mss2dsp,mss3,mss34dsp,mss4,msvideo1,msvideo1enc,mv30,mvcdec,mxpegdec,nellymoser,nellymoserdec,nellymoserenc,notchlc,null,nuv,on2avc,on2avcdata,options,osq,packet,pafaudio,pafvideo,pamenc,parser,parsers,pcm,pcm-bluray,pcm-blurayenc,pcm-dvd,pcm-dvdenc,pcx,pcxenc,pgssubdec,pgxdec,photocd,pictordec,pixblockdsp,pixlet,png_parser,pnm,pnm_parser,pnmdec,pnmenc,profiles,prores_parser,prores_raw,prores_raw_parser,proresdata,proresdec,proresdsp,proresenc_anatoliy,proresenc_kostya,proresenc_kostya_common,prosumer,psd,psymodel,pthread,pthread_frame,pthread_slice,ptx,qcelpdec,qdm2,qdmc,qdrw,qoadec,qoi_parser,qoidec,qoienc,qpeg,qpeldsp,qsv_api,qtrle,qtrleenc,r210dec,r210enc,ra144,ra144dec,ra144enc,ra288,ralf,rangecoder,ratecontrol,raw,rawdec,rawenc,realtextdec,rka,rl,rl2,rle,roqaudioenc,roqvideo,roqvideodec,roqvideoenc,rpza,rpzaenc,rtjpeg,rtv1,rv10,rv10enc,rv20enc,rv30,rv30dsp,rv34,rv34_parser,rv34dsp,rv40,rv40dsp,rv60dec,rv60dsp,s302m,s302menc,samidec,sanm,sbc,sbc_parser,sbcdec,sbcdsp,sbcenc,sbrdsp,sbrdsp_fixed,scpr,sga,sgidec,sgienc,sgirledec,sheervideo,shorten,simple_idct,sinewin,sipr,sipr16k,sipr_parser,siren,smacker,smc,smcenc,smpte_436m,snappy,snow,snow_dwt,snowdec,snowenc,sonic,sp5xdec,speedhq,speedhqdec,speedhqenc,speexdec,srtdec,srtenc,startcode,subviewerdec,sunrast,sunrastenc,svq1,svq1dec,svq1enc,svq3,synth_filter,tak,tak_parser,takdec,takdsp,targa,targa_y216dec,targaenc,textdec,texturedsp,texturedspenc,threadprogress,tiertexseqv,tiff,tiff_common,tiffenc,tmv,to_upper4,tpeldsp,truemotion1,truemotion2,truemotion2rt,truespeech,tscc2,tta,ttadata,ttadsp,ttaenc,ttaencdsp,ttmlenc,twinvq,twinvqdec,txd,ulti,utils,utvideodec,utvideodsp,utvideoenc,v210dec,v210enc,v210x,v308dec,v308enc,v408dec,v408enc,v410dec,v410enc,vb,vble,vbndec,vbnenc,vc1,vc1_block,vc1_loopfilter,vc1_mc,vc1_parser,vc1_pred,vc1data,vc1dec,vc1dsp,vc2enc,vc2enc_dwt,vcr1,version,videodsp,vima,vlc,vmdaudio,vmdvideo,vmixdec,vmnc,vorbis,vorbis_data,vorbis_parser,vorbisdec,vorbisdsp,vorbisenc,vp3,vp3_parser,vp3dsp,vp5,vp56,vp56data,vp5dsp,vp6,vp6dsp,vp8,vp8_parser,vp8data,vp8dsp,vp9,vp9_parser,vp9block,vp9data,vp9dsp,vp9dsp_10bpp,vp9dsp_12bpp,vp9dsp_8bpp,vp9lpf,vp9mvs,vp9prob,vp9recon,vpx_rac,vqavideo,vqcdec,vvc_parser,wavarc,wavpack,wavpackdata,wavpackenc,wbmpdec,wbmpenc,webp,webp_parser,webvttdec,webvttenc,wma,wma_common,wma_freqs,wmadec,wmaenc,wmalosslessdec,wmaprodec,wmavoice,wmv2data,wmv2dec,wmv2dsp,wmv2enc,wnv1,wrapped_avframe,ws-snd1,xan,xbm_parser,xbmdec,xbmenc,xface,xfacedec,xfaceenc,xiph,xl,xma_parser,xpmdec,xsubdec,xsubenc,xvididct,xwd_parser,xwddec,xwdenc,xxan,y41pdec,y41penc,ylc,yop,yuv4dec,yuv4enc}.c",
                "*/src/libavcodec/aac/{aacdec,aacdec_ac,aacdec_fixed,aacdec_float,aacdec_lpd,aacdec_tab,aacdec_usac,aacdec_usac_mps212}.c",
                "*/src/libavcodec/aarch64/{aacencdsp_neon,aacpsdsp_neon,ac3dsp_neon,fdctdsp_neon,fmtconvert_neon,h264cmc_neon,h264dsp_neon,h264idct_neon,h264pred_neon,h264qpel_neon,hevcdsp_deblock_neon,hevcdsp_dequant_neon,hevcdsp_idct_neon,hpeldsp_neon,huffyuvdsp_neon,idctdsp_neon,me_cmp_neon,mpegaudiodsp_neon,mpegvideoencdsp_neon,opusdsp_neon,pixblockdsp_neon,sbrdsp_neon,simple_idct_neon,synth_filter_neon,vc1dsp_neon,videodsp,vorbisdsp_neon,vp8dsp_neon,vp9itxfm_16bpp_neon,vp9itxfm_neon,vp9lpf_16bpp_neon,vp9lpf_neon,vp9mc_16bpp_neon,vp9mc_aarch64,vp9mc_neon}.S",
                "*/src/libavcodec/aarch64/{aacencdsp_init,aacpsdsp_init_aarch64,ac3dsp_init_aarch64,fdctdsp_init_aarch64,fmtconvert_init,h264chroma_init_aarch64,h264dsp_init_aarch64,h264pred_init,h264qpel_init_aarch64,hevcdsp_init_aarch64,hpeldsp_init_aarch64,huffyuvdsp_init_aarch64,idctdsp_init_aarch64,me_cmp_init_aarch64,mpegaudiodsp_init,mpegvideoencdsp_init,opusdsp_init,pixblockdsp_init_aarch64,rv40dsp_init_aarch64,sbrdsp_init_aarch64,synth_filter_init,vc1dsp_init_aarch64,videodsp_init,vorbisdsp_init,vp8dsp_init_aarch64,vp9dsp_init_10bpp_aarch64,vp9dsp_init_12bpp_aarch64,vp9dsp_init_aarch64}.c",
                "*/src/libavcodec/aarch64/h26x/{epel_neon,qpel_neon,sao_neon}.S",
                "*/src/libavcodec/aarch64/vvc/{alf,inter,inter_sme2,sad}.S",
                "*/src/libavcodec/aarch64/vvc/dsp_init.c",
                "*/src/libavcodec/bsf/{aac_adtstoasc,apv_metadata,av1_frame_merge,av1_frame_split,av1_metadata,chomp,dca_core,dovi_rpu,dts2pts,dump_extradata,dv_error_marker,eac3_core,eia608_to_smpte436m,evc_frame_merge,extract_extradata,filter_units,h264_metadata,h264_mp4toannexb,h264_redundant_pps,h265_metadata,h266_metadata,hapqa_extract,hevc_mp4toannexb,imx_dump_header,lcevc_metadata,media100_to_mjpegb,mjpeg2jpeg,mjpega_dump_header,movsub,mpeg2_metadata,mpeg4_unpack_bframes,noise,null,opus_metadata,pcm_rechunk,pgs_frame_merge,prores_metadata,remove_extradata,setts,showinfo,smpte436m_to_eia608,trace_headers,truehd_core,vp9_metadata,vp9_raw_reorder,vp9_superframe,vp9_superframe_split,vvc_mp4toannexb}.c",
                "*/src/libavcodec/hevc/{cabac,data,dsp,filter,hevcdec,mvs,parse,parser,pred,ps,refs,sei}.c",
                "*/src/libavcodec/neon/mpegvideo.c",
                "*/src/libavcodec/opus/{celt,dec,dec_celt,dsp,enc,enc_psy,frame_duration_tab,parse,parser,pvq,rc,silk,tab}.c",
                "*/src/libavcodec/vvc/{cabac,ctu,data,dec,dsp,filter,inter,intra,intra_utils,itx_1d,mvs,ps,refs,sei,thread}.c",
                "*/src/libavdevice/{alldevices,avdevice,lavfi,utils,version}.c",
                "*/src/libavfilter/{aeval,af_aap,af_acontrast,af_acopy,af_acrossover,af_acrusher,af_adeclick,af_adecorrelate,af_adelay,af_adenorm,af_aderivative,af_adrc,af_adynamicequalizer,af_adynamicsmooth,af_aecho,af_aemphasis,af_aexciter,af_afade,af_afftdn,af_afftfilt,af_afir,af_aformat,af_afreqshift,af_afwtdn,af_agate,af_aiir,af_alimiter,af_amerge,af_amix,af_amultiply,af_anequalizer,af_anlmdn,af_anlms,af_anull,af_apad,af_aphaser,af_apsyclip,af_apulsator,af_aresample,af_arls,af_arnndn,af_asdr,af_asetnsamples,af_asetrate,af_ashowinfo,af_asoftclip,af_aspectralstats,af_astats,af_asubboost,af_asupercut,af_atempo,af_atilt,af_axcorrelate,af_biquads,af_channelmap,af_channelsplit,af_chorus,af_compand,af_compensationdelay,af_crossfeed,af_crystalizer,af_dcshift,af_deesser,af_dialoguenhance,af_drmeter,af_dynaudnorm,af_earwax,af_extrastereo,af_firequalizer,af_flanger,af_haas,af_hdcd,af_headphone,af_join,af_loudnorm,af_mcompand,af_pan,af_replaygain,af_sidechaincompress,af_silencedetect,af_silenceremove,af_speechnorm,af_stereotools,af_stereowiden,af_superequalizer,af_surround,af_tremolo,af_vibrato,af_virtualbass,af_volume,af_volumedetect,allfilters,asink_anullsink,asrc_afdelaysrc,asrc_afirsrc,asrc_anoisesrc,asrc_anullsrc,asrc_hilbert,asrc_sinc,asrc_sine,audio,avf_a3dscope,avf_abitscope,avf_ahistogram,avf_aphasemeter,avf_avectorscope,avf_concat,avf_showcqt,avf_showcwt,avf_showfreqs,avf_showspatial,avf_showspectrum,avf_showvolume,avf_showwaves,avfilter,avfiltergraph,bbox,buffersink,buffersrc,bwdifdsp,ccfifo,colorspace,colorspacedsp,drawutils,ebur128,edge_common,f_bench,f_cue,f_drawgraph,f_ebur128,f_graphmonitor,f_interleave,f_latency,f_loop,f_metadata,f_perms,f_realtime,f_reverse,f_segment,f_select,f_sendcmd,f_sidedata,f_streamselect,formats,framepool,framequeue,framesync,generate_wave_table,graphdump,graphparser,lavfutils,lswsutils,motion_estimation,palette,perlin,psnr,pthread,qp_table,scale_eval,scene_sad,setpts,settb,split,src_avsynctest,src_movie,transform,trim,vaf_spectrumsynth,version,vf_addroi,vf_alphamerge,vf_amplify,vf_aspect,vf_atadenoise,vf_avgblur,vf_backgroundkey,vf_bbox,vf_bilateral,vf_bitplanenoise,vf_blackdetect,vf_blend,vf_blockdetect,vf_blurdetect,vf_bm3d,vf_bwdif,vf_cas,vf_ccrepack,vf_chromakey,vf_chromanr,vf_chromashift,vf_ciescope,vf_codecview,vf_colorbalance,vf_colorchannelmixer,vf_colorconstancy,vf_colorcontrast,vf_colorcorrect,vf_colordetect,vf_colorize,vf_colorkey,vf_colorlevels,vf_colormap,vf_colorspace,vf_colortemperature,vf_convolution,vf_convolve,vf_copy,vf_corr,vf_crop,vf_curves,vf_datascope,vf_dblur,vf_dctdnoiz,vf_deband,vf_deblock,vf_decimate,vf_dedot,vf_deflicker,vf_dejudder,vf_deshake,vf_despill,vf_detelecine,vf_displace,vf_drawbox,vf_edgedetect,vf_elbg,vf_entropy,vf_epx,vf_estdif,vf_exposure,vf_extractplanes,vf_fade,vf_feedback,vf_fftdnoiz,vf_fftfilt,vf_field,vf_fieldhint,vf_fieldmatch,vf_fieldorder,vf_fillborders,vf_floodfill,vf_format,vf_fps,vf_framepack,vf_framerate,vf_framestep,vf_freezedetect,vf_freezeframes,vf_fsync,vf_gblur,vf_geq,vf_gradfun,vf_grayworld,vf_guided,vf_hflip,vf_histogram,vf_hqx,vf_hsvkey,vf_hue,vf_huesaturation,vf_hwdownload,vf_hwmap,vf_hwupload,vf_hysteresis,vf_identity,vf_idet,vf_idetdsp,vf_il,vf_lagfun,vf_lenscorrection,vf_limitdiff,vf_limiter,vf_lumakey,vf_lut,vf_lut2,vf_lut3d,vf_maskedclamp,vf_maskedmerge,vf_maskedminmax,vf_maskedthreshold,vf_maskfun,vf_median,vf_mergeplanes,vf_mestimate,vf_midequalizer,vf_minterpolate,vf_mix,vf_monochrome,vf_morpho,vf_multiply,vf_negate,vf_neighbor,vf_nlmeans,vf_noise,vf_normalize,vf_null,vf_overlay,vf_pad,vf_palettegen,vf_paletteuse,vf_photosensitivity,vf_pixdesctest,vf_pixelize,vf_premultiply,vf_pseudocolor,vf_psnr,vf_qp,vf_random,vf_readeia608,vf_readvitc,vf_remap,vf_removegrain,vf_removelogo,vf_rotate,vf_scale,vf_scdet,vf_scroll,vf_selectivecolor,vf_separatefields,vf_setparams,vf_shear,vf_showinfo,vf_showpalette,vf_shuffleframes,vf_shufflepixels,vf_shuffleplanes,vf_signalstats,vf_siti,vf_ssim,vf_ssim360,vf_stack,vf_swaprect,vf_swapuv,vf_telecine,vf_threshold,vf_thumbnail,vf_tile,vf_tiltandshift,vf_tmidequalizer,vf_tonemap,vf_tpad,vf_transpose,vf_unsharp,vf_untile,vf_v360,vf_varblur,vf_vectorscope,vf_vflip,vf_vfrdet,vf_vibrance,vf_vif,vf_vignette,vf_vmafmotion,vf_w3fdif,vf_waveform,vf_weave,vf_xbr,vf_xfade,vf_xmedian,vf_xpsnr,vf_yadif,vf_yaepblur,vf_zoompan,video,vsink_nullsink,vsrc_cellauto,vsrc_gradients,vsrc_life,vsrc_mandelbrot,vsrc_perlin,vsrc_sierpinski,vsrc_testsrc,yadif_common}.c",
                "*/src/libavfilter/aarch64/{vf_bwdif_neon,vf_colordetect_neon,vf_nlmeans_neon}.S",
                "*/src/libavfilter/aarch64/{vf_bwdif_init_aarch64,vf_colordetect_init,vf_nlmeans_init}.c",
                "*/src/libavformat/{3dostr,4xm,a64,aacdec,aadec,aaxdec,ac3dec,ac4dec,ac4enc,acedec,acm,act,adp,ads,adtsenc,adxdec,aeadec,aeaenc,afc,aiff,aiffdec,aiffenc,aixdec,allformats,alp,amr,amvenc,anm,apac,apc,ape,apetag,apm,apngdec,apngenc,aptxdec,apv,apvdec,apvenc,aqtitledec,argo_asf,argo_brp,argo_cvg,asf,asf_tags,asfcrypt,asfdec_f,asfdec_o,asfenc,assdec,assenc,ast,astdec,astenc,async,au,av1,av1dec,avc,avformat,avidec,avienc,avio,aviobuf,avlanguage,avr,avs,avs2dec,avs3dec,bethsoftvid,bfi,bink,binka,bintext,bit,bmv,boadec,bonk,brstm,c93,cache,caf,cafdec,cafenc,cavsvideodec,cbs,cbs_apv,cbs_av1,cdg,cdxl,cinedec,codec2,codecstring,concat,concatdec,crcenc,crypto,dash,dashenc,data_uri,dauddec,daudenc,dcstr,demux,demux_utils,derf,dfa,dfpwmdec,dhav,diracdec,dnxhddec,dovi_isom,dsfdec,dsicin,dss,dtsdec,dtshddec,dump,dv,dvbsub,dvbtxt,dvdclut,dvenc,dxa,eacdata,electronicarts,epafdec,evc,evcdec,ffmetadec,ffmetaenc,fifo,file,filmstripdec,filmstripenc,fitsdec,fitsenc,flac_picture,flacdec,flacenc,flacenc_header,flic,flvdec,flvenc,format,framecrcenc,framehash,frmdec,fsb,ftp,fwse,g722,g723_1,g726,g728dec,g729dec,gdv,genh,gif,gifdec,gopher,gsmdec,gxf,gxfenc,h261dec,h263dec,h264dec,hashenc,hca,hcom,hdsenc,hevc,hevcdec,hls,hls_sample_encryption,hlsenc,hlsplaylist,hnm,http,httpauth,hxvs,iamf,iamf_parse,iamf_reader,iamf_writer,iamfdec,iamfenc,icecast,icodec,icoenc,id3v1,id3v2,id3v2enc,idcin,idroqdec,idroqenc,iff,ifv,ilbc,img2,img2_alias_pix,img2_brender_pix,img2dec,img2enc,imx,ingenientdec,ip,ipmovie,ipudec,ircam,ircamdec,ircamenc,isom,isom_tags,iss,iv8,ivfdec,ivfenc,jacosubdec,jacosubenc,jpegxl_anim_dec,jvdec,kvag,lafdec,latmenc,lc3,lmlm4,loasdec,lrc,lrcdec,lrcenc,luodatdec,lvfdec,lxfdec,m4vdec,matroska,matroskadec,matroskaenc,mca,mccdec,mccenc,md5proto,metadata,mgsts,microdvddec,microdvdenc,mj2kdec,mkvtimestamp_v2,mlpdec,mlvdec,mm,mmf,mms,mmsh,mmst,mods,moflex,mov,mov_chan,mov_esds,movenc,movenc_ttml,movenccenc,movenchint,mp3dec,mp3enc,mpc,mpc8,mpeg,mpegenc,mpegts,mpegtsenc,mpegvideodec,mpjpeg,mpjpegdec,mpl2dec,mpsubdec,msf,msnwc_tcp,mspdec,mtaf,mtv,musx,mux,mux_utils,mvdec,mvi,mxf,mxfdec,mxfenc,mxg,nal,ncdec,network,nistspheredec,nspdec,nsvdec,nullenc,nut,nutdec,nutenc,nuv,oggdec,oggenc,oggparsecelt,oggparsedirac,oggparseflac,oggparseogm,oggparseopus,oggparseskeleton,oggparsespeex,oggparsetheora,oggparsevorbis,oggparsevp8,oma,omadec,omaenc,options,os_support,osq,paf,pcm,pcmdec,pcmenc,pdvdec,pjsdec,pmpdec,pp_bnk,prompeg,protocols,psxstr,pva,pvfdec,qcp,qoadec,qtpalette,r3d,rawdec,rawenc,rawutils,rawvideodec,rcwtdec,rcwtenc,rdt,realtextdec,redspark,replaygain,riff,riffdec,riffenc,rka,rl2,rm,rmdec,rmenc,rmsipr,rpl,rsd,rso,rsodec,rsoenc,rtmpdigest,rtmphttp,rtmppkt,rtmpproto,rtp,rtpdec,rtpdec_ac3,rtpdec_amr,rtpdec_asf,rtpdec_av1,rtpdec_dv,rtpdec_g726,rtpdec_h261,rtpdec_h263,rtpdec_h263_rfc2190,rtpdec_h264,rtpdec_hevc,rtpdec_ilbc,rtpdec_jpeg,rtpdec_latm,rtpdec_mpa_robust,rtpdec_mpeg12,rtpdec_mpeg4,rtpdec_mpegts,rtpdec_opus,rtpdec_qcelp,rtpdec_qdm2,rtpdec_qt,rtpdec_rfc4175,rtpdec_svq3,rtpdec_vc2hq,rtpdec_vp8,rtpdec_vp9,rtpdec_xiph,rtpenc,rtpenc_aac,rtpenc_amr,rtpenc_av1,rtpenc_chain,rtpenc_h261,rtpenc_h263,rtpenc_h263_rfc2190,rtpenc_h264_hevc,rtpenc_jpeg,rtpenc_latm,rtpenc_mpegts,rtpenc_mpv,rtpenc_rfc4175,rtpenc_vc2hq,rtpenc_vp8,rtpenc_vp9,rtpenc_xiph,rtpproto,rtsp,rtspdec,rtspenc,s337m,samidec,sapdec,sapenc,sauce,sbcdec,sbgdec,sccdec,sccenc,scd,sdns,sdp,sdr2,sdsdec,sdxdec,seek,segafilm,segafilmenc,segment,serdec,sga,shortendec,sierravmd,siff,smacker,smjpeg,smjpegdec,smjpegenc,smoothstreamingenc,smush,sol,soxdec,soxenc,spdif,spdifdec,spdifenc,srtdec,srtenc,srtp,srtpproto,stldec,subfile,subtitles,subviewer1dec,subviewerdec,supdec,supenc,svag,svs,swf,swfdec,swfenc,takdec,tcp,tedcaptionsdec,tee,tee_common,teeproto,thp,tiertexseq,tmv,tta,ttaenc,ttmlenc,tty,txd,ty,udp,uncodedframecrcenc,unix,url,urldecode,usmdec,utils,vag,vc1dec,vc1test,vc1testenc,version,vividas,vivo,voc,voc_packet,vocdec,vocenc,vorbiscomment,vpcc,vpk,vplayerdec,vqf,vvc,vvcdec,w64,wady,wavarc,wavdec,wavenc,wc3movie,webm_chunk,webmdashenc,webpenc,webvttdec,webvttenc,westwood_aud,westwood_audenc,westwood_vqa,wsddec,wtv_common,wtvdec,wtvenc,wv,wvdec,wvedec,wvenc,xa,xmd,xmv,xvag,xwma,yop,yuv4mpegdec,yuv4mpegenc}.c",
                "*/src/libavutil/{adler32,aes,aes_ctr,ambient_viewing_environment,audio_fifo,avsscanf,avstring,base64,blowfish,bprint,buffer,camellia,cast5,channel_layout,container_fifo,cpu,crc,csp,des,detection_bbox,dict,display,dovi_meta,downmix_info,encryption_info,error,eval,executor,fifo,file,file_open,film_grain_params,fixed_dsp,float2half,float_dsp,float_scalarproduct,frame,half2float,hash,hdr_dynamic_metadata,hdr_dynamic_vivid_metadata,hmac,hwcontext,hwcontext_stub,iamf,imgutils,integer,intmath,lfg,lls,log,log2_tab,lzo,mastering_display_metadata,mathematics,md5,mem,murmur3,opt,parseutils,pixdesc,pixelutils,random_seed,rational,rc4,refstruct,reverse,ripemd,samplefmt,sha,sha512,side_data,slicethread,spherical,stereo3d,tdrdi,tea,threadmessage,time,timecode,timecode_internal,timestamp,tree,twofish,tx,tx_double,tx_float,tx_int32,utils,uuid,version,video_enc_params,video_hint,xga_font_data,xtea}.c",
                "*/src/libavutil/aarch64/{cpu_sme,cpu_sve,crc,float_dsp_neon,tx_float_neon}.S",
                "*/src/libavutil/aarch64/{cpu,float_dsp_init,tx_float_init}.c",
                "*/src/libswresample/{audioconvert,dither,options,rematrix,resample,resample_dsp,swresample,swresample_frame,version}.c",
                "*/src/libswresample/aarch64/{audio_convert_neon,resample}.S",
                "*/src/libswresample/aarch64/{audio_convert_init,resample_init}.c",
                "*/src/libswscale/{alphablend,cms,csputils,format,gamma,graph,hscale,hscale_fast_bilinear,input,lut3d,ops,ops_backend,ops_chain,ops_dispatch,ops_memcpy,ops_optimizer,options,output,rgb2rgb,slice,swscale,swscale_unscaled,utils,version,vscale,yuv2rgb}.c",
                "*/src/libswscale/aarch64/{hscale,input,output,range_convert_neon,rgb2rgb_neon,swscale_unscaled_neon,xyz2rgb_neon,yuv2rgb_neon}.S",
                "*/src/libswscale/aarch64/{rgb2rgb,swscale,swscale_unscaled}.c",
            },
            generated_files = {
                ["config.h"] = [==[
/* Automatically generated by configure - do not modify! */
