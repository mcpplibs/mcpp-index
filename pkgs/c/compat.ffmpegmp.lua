-- Multi-platform (linux-x86_64 + macosx-arm64) FFmpeg 8.1.2, full source build.
-- Per-OS frozen config snapshots under mcpp.<os>; consumers build from source
-- with zero configure/make. Auto-generated (spike) — do not edit by hand.
package = {
    spec = "1", namespace = "compat", name = "compat.ffmpegmp",
