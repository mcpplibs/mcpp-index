...
-- V4L2 videoio, WITH_UNIFONT=OFF); SIMD runtime
...
package = {
    ...
    mcpp = {
        ...
        cflags   = { "-msse3", "-w" },
        flags = {
            { glob = "**/modules/core/**", defines = { "HAVE_STDARG_H=1", "NDEBUG", "OPENCV_ALLOCATOR_STATS_COUNTER_TYPE=long long", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_USE_MATH_DEFINES", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
            { glob = "**/modules/flann/**", defines = { "NDEBUG", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_USE_MATH_DEFINES", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
            { glob = "**/modules/geometry/**", defines = { "NDEBUG", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_USE_MATH_DEFINES", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
            { glob = "**/modules/highgui/**", defines = { "ENABLE_PLUGINS", "NDEBUG", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_USE_MATH_DEFINES", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
            { glob = "**/modules/imgcodecs/**", defines = { "HAVE_IMGCODEC_HDR", "HAVE_IMGCODEC_PFM", "HAVE_IMGCODEC_PXM", "HAVE_IMGCODEC_SUNRASTER", "HAVE_STDARG_H=1", "NDEBUG", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_USE_MATH_DEFINES", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
            { glob = "**/modules/imgproc/**", defines = { "HAVE_STDARG_H=1", "NDEBUG", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_USE_MATH_DEFINES", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
            { glob = "**/3rdparty/libjpeg-turbo/**", defines = { "NDEBUG", "NO_GETENV", "NO_PUTENV", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS" } },
            { glob = "**/tu/jpeg12/**", defines = { "BITS_IN_JSAMPLE=12", "NDEBUG", "NO_GETENV", "NO_PUTENV", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS" } },
            { glob = "**/tu/jpeg16/**", defines = { "BITS_IN_JSAMPLE=16", "NDEBUG", "NO_GETENV", "NO_PUTENV", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS" } },
            { glob = "**/3rdparty/mlas/**" },
            { glob = "**/3rdparty/libpng/**", defines = { "HAVE_STDARG_H=1", "NDEBUG", "PNG_INTEL_SSE_OPT=1", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS" } },
            { glob = "**/3rdparty/zlib/**", defines = { "HAVE_STDARG_H=1", "NDEBUG", "NO_FSEEKO", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS" } },
            { glob = "**/*.asm", defines = { "NO_GETENV", "NO_PUTENV", "WIN64", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "__x86_64__" } },
            ...
            { glob = "**/clsrc/opencl_kernels_core.cpp", defines = { "HAVE_STDARG_H=1", "NDEBUG", "OPENCV_ALLOCATOR_STATS_COUNTER_TYPE=long long", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_USE_MATH_DEFINES", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
            { glob = "**/clsrc/opencl_kernels_geometry.cpp", defines = { "NDEBUG", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_USE_MATH_DEFINES", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
            { glob = "**/clsrc/opencl_kernels_imgproc.cpp", defines = { "HAVE_STDARG_H=1", "NDEBUG", "WIN32", "_CRT_NONSTDC_NO_DEPRECATE", "_CRT_SECURE_NO_DEPRECATE", "_SCL_SECURE_NO_WARNINGS", "_USE_MATH_DEFINES", "_VARIADIC_MAX=10", "_WIN32_WINNT=0x0601", "_WINDOWS", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
            { glob = "*/modules/core/src/alloc.cpp", defines = { "HAVE_MALLOC_H=1", "HAVE_WIN32_ALIGNED_MALLOC=1" } },
            { glob = "*/modules/core/src/parallel/parallel.cpp", defines = { "DEBUG_POSTFIX=d", "PARALLEL_ENABLE_PLUGINS=1" } },
        ...
        -- sources (0 TUs: modules/dnn + vendored protobuf + mlas incl.
...
"  Version control:               313f01d\n"
"\n"
"  Platform:\n"
"    Timestamp:                   2026-07-19T20:10:34Z\n"
