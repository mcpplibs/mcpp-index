...
package = {
    ...
    mcpp = {
        ...
        flags = {
            ...
            { glob = "**/tu/jpeg12/**", defines = { "BITS_IN_JSAMPLE=12", "NDEBUG", "NEON_INTRINSICS", "NO_GETENV", "NO_PUTENV" } },
            { glob = "**/tu/jpeg16/**", defines = { "BITS_IN_JSAMPLE=16", "NDEBUG", "NEON_INTRINSICS", "NO_GETENV", "NO_PUTENV" } },
            { glob = "**/3rdparty/mlas/**" },
            { glob = "**/3rdparty/libpng/**", defines = { "HAVE_STDARG_H=1", "HAVE_UNISTD_H=1", "NDEBUG", "PNG_ARM_NEON_OPT=2" } },
            { glob = "**/3rdparty/zlib/**", defines = { "HAVE_STDARG_H=1", "HAVE_UNISTD_H=1", "NDEBUG" } },
            { glob = "**/modules/core/**/*.neon.cpp", defines = { "CV_CPU_DISPATCH_MODE=NEON" }, cxxflags = {  } },
            { glob = "**/modules/imgproc/**/*.neon.cpp", defines = { "CV_CPU_DISPATCH_MODE=NEON" }, cxxflags = {  } },
            { glob = "**/clsrc/opencl_kernels_core.cpp", defines = { "HAVE_STDARG_H=1", "HAVE_UNISTD_H=1", "NDEBUG", "OPENCV_ALLOCATOR_STATS_COUNTER_TYPE=int", "_USE_MATH_DEFINES", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
            ...
            { glob = "*/modules/core/src/alloc.cpp", defines = { "HAVE_POSIX_MEMALIGN=1" } },
...
"  Version control:               5197d55\n"
"\n"
"  Platform:\n"
"    Timestamp:                   2026-07-19T10:19:09Z\n"
...
"\n"
"  OpenCV modules:\n"
"    To be built:                 core flann geometry imgcodecs imgproc\n"
"    Disabled:                    world\n"
"    Disabled by dependency:      calib dnn features highgui java_bindings_generator js_bindings_generator objc_bindings_generator objdetect photo ptcloud python_bindings_generator python_tests stereo stitching video videoio\n"
