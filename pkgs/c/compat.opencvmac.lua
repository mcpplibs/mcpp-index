...
package = {
    ...
    mcpp = {
        ...
        flags = {
            ...
            { glob = "**/modules/videoio/**", defines = { "ENABLE_PLUGINS", "HAVE_FFMPEG", "HAVE_FFMPEG_LIBAVDEVICE", "NDEBUG", "_USE_MATH_DEFINES", "__OPENCV_BUILD=1", "__STDC_CONSTANT_MACROS", "__STDC_FORMAT_MACROS", "__STDC_LIMIT_MACROS" } },
