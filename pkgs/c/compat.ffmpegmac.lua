-- TEMP macOS-arm64 build spike (NOT the real descriptor): validates that mcpp
-- compiles the full FFmpeg 8.1.2 arm64 source set (2091 sources, 60 GAS .S,
-- 0 NASM) on macos-15 with the captured hermetic config snapshot. macos-only xpm.
package = {
    spec = "1", namespace = "compat", name = "compat.ffmpegmac",
    description = "FFmpeg 8.1.2 macOS-arm64 build spike (temp)",
    licenses = {"LGPL-2.1-or-later"}, repo = "https://ffmpeg.org", type = "package",
    xpm = { macosx = { ["8.1.2"] = {
        url = { GLOBAL = "https://ffmpeg.org/releases/ffmpeg-8.1.2.tar.gz",
