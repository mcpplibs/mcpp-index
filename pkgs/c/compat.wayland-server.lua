-- compat.wayland-server — libwayland-server, the compositor side of the protocol.
--
...
package = {
    ...
    namespace   = "compat",
    name        = "wayland-server",
    description = "libwayland-server — the compositor side of the Wayland protocol, built from source",
    licenses    = {"MIT"},
